...
//        Comment comment1 = new Comment(0,user5,game5,"comment_text1","2");//new Timestamp(System.currentTimeMillis()));
//        Comment comment2 = new Comment(0,user5,game5,"comment_text2","2");//new Timestamp(System.currentTimeMillis()));
